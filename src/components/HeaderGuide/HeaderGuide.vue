  <template>
    ...
    <div class="headerWarp">
      <a class="home-icon" href="javascript:;" @click="$router.history.replace('/home')"></a>
      <a class="logoWarp" href="javascript:;" @click="$router.history.replace('/home')">
        <i class="logo-icon"></i>
      </a>
      <div class="rightWarp">
        <a class="searchWarp" href="javascript:;" @click="$router.history.replace('/search')">
          <i class="search-icon"></i>
        </a>
        <a class="shopcarWarp" href="javascript:;" @click="$router.history.replace('/shopcar')">
          <i class="shop-icon"></i>
        </a>
      </div>
    </div>
